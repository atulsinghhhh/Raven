...
const LIMIT_GROUPS = [
  ...
  [
    ...
    ['maxConcurrentStreams', 'maxViewers', 'maxStreamDurationMinutes'],
  ],
  [
    'Chat',
    [
...
const LIMIT_LABELS = {
  ...
  maxParticipantsPerLiveStreamRoom: 'Participants per live-stream room (raised so the viewer cap below is reachable)',
  maxConcurrentStreams: 'Concurrent LIVE streams per account',
  maxViewers: 'Viewers per stream',
  maxStreamDurationMinutes: 'Maximum stream duration (minutes)',
