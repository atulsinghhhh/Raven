...
- [`01ebb72`](https://github.com/atulsinghhhh/Raven/commit/01ebb72c21f18ed79149bb357a2245853d81f9b7) Thanks [@atulsinghhhh](https://github.com/atulsinghhhh)! - Publish real simulcast, and make adaptiveStream real
  ...
  requires implementations to reject a change to a sender's _number_ of
  ...
  **`RemoteTrack.setLayer(layer)` is new**, and it _pins_: adaptive
...
- [#55](https://github.com/atulsinghhhh/Raven/pull/55) [`501d552`](https://github.com/atulsinghhhh/Raven/commit/501d5529f61b16d1eb461ecd8a59dc3095adf1b2) Thanks [@atulsinghhhh](https://github.com/atulsinghhhh)! - Serialize negotiation, restore media across reconnects, bootstrap the data channel, and support application-provided tracks
...
state: stable`. Either way the publish never negotiated — the sender
  ...
  bit clears when _any_ description covers the change, including one the SFU
...
- [#48](https://github.com/atulsinghhhh/Raven/pull/48) [`ee0f646`](https://github.com/atulsinghhhh/Raven/commit/ee0f646721f247b7647fbf06ccaccf2c974084d9) Thanks [@atulsinghhhh](https://github.com/atulsinghhhh)! - Take a publication's id from the SDP, not from the local track
  ...
  through [#46](https://github.com/atulsinghhhh/Raven/issues/46) with no changeset of its own and would otherwise go out
  undescribed.
