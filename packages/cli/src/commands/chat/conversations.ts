      ...
      withErrorHandling(async (opts: { project?: string; json?: boolean }) => {
        ...
        if (conversations.length === 0) {
          printEmpty(
            ...
            'Conversations are created from your backend; a browser chat token cannot create them. Use raven.chat.createConversation() from @ravenkash/server or livqeno-sdk.',
          );
          return;
        }
