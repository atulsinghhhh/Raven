...
export function detectCapabilities(
  ...
  const captureStream =
    typeof (win as unknown as { HTMLCanvasElement?: { prototype?: { captureStream?: unknown } } }).HTMLCanvasElement
      ?.prototype?.captureStream === 'function';
  const requestVideoFrameCallback =
    typeof (win as unknown as { HTMLVideoElement?: { prototype?: { requestVideoFrameCallback?: unknown } } })
