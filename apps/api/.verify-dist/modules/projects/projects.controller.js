...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: "List the authenticated developer's projects" }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Active projects owned by the caller' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get a single project' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Project found' }),
    (0, swagger_1.ApiNotFoundResponse)({
        description: "Project doesn't exist, OR belongs to a different developer — deliberately indistinguishable, to avoid confirming another account's project ID is real.",
    }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    ...
    (0, swagger_1.ApiNotFoundResponse)({ description: 'Not found, or not owned by the caller' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 204, description: 'Project archived' }),
    (0, swagger_1.ApiNotFoundResponse)({ description: 'Not found, or not owned by the caller' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
