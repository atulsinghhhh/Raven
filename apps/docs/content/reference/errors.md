---
title: Error Codes
description: One canonical namespace, plus the two wire protocols that deliberately keep their own.
---
...
| **Chat frame codes** | The chat WebSocket `error` frame | A published wire protocol with its own lifetime; see [WebSocket Protocol](/chat/websocket) |
