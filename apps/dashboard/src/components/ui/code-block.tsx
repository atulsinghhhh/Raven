...
const KEYWORDS: Record<string, string[]> = {
  typescript: ['import','from','export','const','let','var','function','async','await','return','if','else','for','while','new','class','extends','interface','type','try','catch','finally','throw','typeof','default','of','in','as','void','null','undefined','true','false'],
  javascript: ['import','from','export','const','let','var','function','async','await','return','if','else','for','while','new','class','extends','try','catch','finally','throw','typeof','default','of','in','void','null','undefined','true','false'],
  python: ['import','from','def','class','return','if','elif','else','for','while','with','as','try','except','finally','raise','async','await','lambda','None','True','False','in','not','and','or','print'],
  bash: ['curl','npm','pnpm','yarn','pip','export','cd','echo','sudo','apt','brew','git','node','python','npx'],
