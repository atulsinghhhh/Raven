...
/** Security: a shield, for the Super Admin Portal's security center. */
export const IconShield = (p: IconProps) => (
  <Svg {...p}>
    <path d="M8 1.75 13.25 3.5v4c0 3.6-2.35 5.9-5.25 6.75-2.9-.85-5.25-3.15-5.25-6.75v-4z" />
    <path d="M5.75 8 7.25 9.5l3-3.25" />
  </Svg>
);

/** Infrastructure: a stack of server rack units. */
