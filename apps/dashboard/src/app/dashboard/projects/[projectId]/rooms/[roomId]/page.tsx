      ...
      <section>
        ...
        {liveParticipants === null ? (
          ...
          <EmptyState
            ...
            description="The room exists and is reachable, but nobody is in it. Participants appear here as soon as a client joins with @raven/rtc."
          />
        ) : (
      ...
      <section>
        ...
        {!connections ? (
          ...
          <EmptyState
            ...
            description="Connection telemetry is written when a client joins with @raven/rtc. A room created by your backend but never joined has no records."
          />
        ) : (
          <>
