    ...
    return (
      <div className="flex flex-col gap-6">
        ...
        <EmptyState
          ...
          description="Conversations are created from your backend — a browser chat token can't create them, by design. Use raven.chat.createConversation() from @ravenkash/server."
          action={
